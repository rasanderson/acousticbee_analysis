...
# No records at Thorganby site as not assessed. Remove missing values.
...
# Split data into train and test, meta- and audio- using same time points ####
# Add random seed for consistency between runs
set_random_seed(123)
...
# Setup data for "acoustic" variables ####
...
# Scale the meta and acoustic features as all in different units originally
...
# Create the DL model ####
# Define upper branches of deep learning model for meta- and acoustic ####
# meta-data part of DL model
...
# acoustic-indices part of DL model
...
# Define the two top-most branches as inputs and concatenate together ####
merge_inputs <-
...
# Finish with graphs of observed vs predictions and r-squared
...
# Error distribution (not really needed)
ggplot(test_obs_preds, aes(x = pred - varroa)) +
  geom_density()

# Check r-squared of predictions for the test dataset
